...
<div class="min-h-screen bg-gray-100/80 p-6 font-sans">
    <div class="max-w-3xl mx-auto bg-white shadow-xl p-8">
        ...
        <form action="{{ route('hero.update', $hero->id) }}"
              method="POST"
            ...
            <div>
                ...
                <textarea name="subtitle"
                          rows="4"
                          class="w-full border shadow-sm px-3 py-2 text-sm focus:outline-none focus:ring focus:border-blue-400">{{ old('subtitle', $hero->subtitle) }}</textarea>
            </div>
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm text-gray-600">Aktifkan Hero</span>
            </div>
