        ...
        <form action="{{ route('admin.about.update', $about->id) }}"
            ...
            <div>
                ...
                <textarea name="description"
                          rows="4"
                          required
                          class="w-full border shadow-sm px-3 py-2 text-sm focus:outline-none focus:ring focus:border-blue-400">{{ old('description', $about->description) }}</textarea>
            </div>
            ...
            <div>
                ...
                <input type="number"
                       name="sort_order"
                       value="{{ old('sort_order', $about->sort_order) }}"
                       class="w-full border shadow-sm px-3 py-2 text-sm focus:outline-none focus:ring focus:border-blue-400">
            </div>
